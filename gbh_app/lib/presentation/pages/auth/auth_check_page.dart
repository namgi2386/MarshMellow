...
class _AuthCheckPageState extends ConsumerState<AuthCheckPage> {
  ...
  Future<void> _checkAuthStatus() async {
    ...
    await secureStorage.write(
        ...
        value:
            'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiJ9.eyJ0b2tlblR5cGUiOiJBQ0NFU1MiLCJ1c2VyUGsiOjMsInN1YiI6ImFjY2Vzcy10b2tlbiIsImlhdCI6MTc0NDA0ODU3OSwiZXhwIjoxNzQ0MDY2NTc5fQ.mwAS6XqeyPGagdQB4PnG6i_josJ3_qZOYzYblOh1vuyxBaV1GuMSHCgVsxw8bk1qTVrqph0Zy1PqU0T3Mt-0ig');
    await secureStorage.write(
        key: StorageKeys.refreshToken,
        value:
            'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiJ9.eyJ0b2tlblR5cGUiOiJSRUZSRVNIIiwidXNlclBrIjozLCJzdWIiOiJyZWZyZXNoLXRva2VuIiwiaWF0IjoxNzQ0MDQ4NTc5LCJleHAiOjE3Njk5Njg1Nzl9.ZlT3PR2b6EJn1w6T-SUbKRiR1_BkbIVJ70YcmQ0a9wTft7J1uq77TZzZsi5jhuu_G1k9hGltWR9nWEWi-ZBLRA');
    await secureStorage.write(
