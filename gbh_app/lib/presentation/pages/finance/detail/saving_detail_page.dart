      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  Text(
                    '${bankName} | ${_formatAccountNumber(accountNo)}', 
          ...
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text('적금 총액', style: AppTextStyles.bodyMedium.copyWith(color: AppColors.divider)),
              Text(
                '${formatter.format(int.parse(item.totalBalance))}원',
  ...
  Widget _buildSavingInfo(SavingPaymentItem item) {
    ...
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text('적금 정보', style: AppTextStyles.bodyMedium.copyWith(fontWeight: FontWeight.bold)),
                            ...
                            children: [
                              ...
                              Text(
                                ...
                                style: AppTextStyles.bodySmall.copyWith(
                                  color: isSuccess ? Colors.grey : AppColors.warnningLight
                                ),
                              ),
                            ],
                          ),
